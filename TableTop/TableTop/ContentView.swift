...
struct ARViewContainer: UIViewRepresentable {
    ...
    private func place(_ modelEntity: ModelEntity, in arView: ARView) {
        ...
        for ch in clonedEntity.children {
            ...
            arView.installGestures(for: ch as! HasCollision)//.forEach { entityGesture in
                /* entityGesture.addTarget(arView, action: #selector(CustomARView.transformObject(_:)))
            }*/
            self.sceneManager.modelEntities.append(ch as! ModelEntity)
        }
